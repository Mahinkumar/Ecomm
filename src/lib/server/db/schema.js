...
export const sales = pgTable("sales" ,{
    user_id: serial("user_id").references(()=>user.user_id),
    ...
    transaction_id: serial("transaction_id").references(()=>transactions.transaction_id)
})
